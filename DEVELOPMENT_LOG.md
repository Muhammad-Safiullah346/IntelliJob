...
IntelliJob/Global.asax.cs: redirected the root request to /User/Home.aspx so fresh clones open on the correct landing page without relying on .csproj.user.
